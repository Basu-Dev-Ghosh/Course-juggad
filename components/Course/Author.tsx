...
const Author = () => {
  return (
    <div className="md:col-span-2 bg-border w-full h-full rounded-xl px-8 py-4 md:py-6 flex justify-center items-center">
      <div className="bg-primary md:w-[90%] md:h-[90%] rounded-2xl flex flex-col items-center py-6 md:py-10 ">
        <p className="text-white text-lg">Meet our creator</p>
