...
const Footer = () => {
  return (
    <footer className="w-full py-14 mt-16">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="w-full flex justify-center">
          <Logo />
        </div>
        <div className="max-w-full mx-1 md:mx-auto">
          <ul className="text-lg px-8 flex-wrap flex md:items-center justify-center  gap-7 flex-row md:gap-12 transition-all duration-500 py-16 mb-10 border-b border-gray-200">
            <li>
          ...
          <span className="text-lg text-gray-500 text-center block">
            ©<a href="https://pagedone.io/">course juggad</a> 2024, All rights
            reserved.
          </span>
        </div>
      </div>
